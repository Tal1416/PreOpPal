...
export default function TopAppBar() {
  ...
  return (
    <header className="fixed top-0 left-0 lg:left-64 right-0 z-30 flex h-16 items-center justify-between px-4 lg:px-8 bg-white/70 backdrop-blur-xl border-b border-white/40 shadow-[0_8px_32px_0_rgba(42,122,140,0.04)]">
